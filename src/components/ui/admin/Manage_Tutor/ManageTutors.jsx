      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Manage Tutors</h1>
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              ...
              <div className="relative" ref={importRef}>
                ...
                {importOpen && (
                  <div className="absolute top-full mt-2 right-0 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50">
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">Import Tutors</h3>
                    <div className="space-y-3">
                      ...
                      />
                      {importStatus.error && (
                        <div className="text-xs text-red-600 bg-red-50 p-2 rounded">{importStatus.error}</div>
                      )}
                      {importStatus.message && (
                        <div className="text-xs text-green-600 bg-green-50 p-2 rounded">{importStatus.message}</div>
                      )}
                    </div>
              ...
              <div className="relative" ref={exportRef}>
                ...
                {exportOpen && (
                  <div className="absolute top-full mt-2 right-0 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                    <button
                      onClick={exportToExcel}
        ...
        <div className="lg:hidden mb-4">
          <button
            onClick={() => setMobileFiltersOpen(true)}
            className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 px-4 py-2.5 rounded-lg hover:bg-gray-50 text-sm font-medium text-gray-700"
          >
        ...
        {/* Desktop Filters - Updated to dropdown style */}
        <div className="hidden lg:flex items-center gap-3 mb-6 flex-wrap">
          ...
          <div className="relative">
            <select
              onChange={(e) => setTimeFilter(e.target.value)}
              value={timeFilter}
              className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm min-w-[150px] appearance-none bg-white pr-8"
            >
              {timeFilterOptions.map(option => (
                <option key={option.value} value={option.value}>
                  {option.label}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="text-sm font-medium text-gray-600">Total Tutors</div>
            <div className="mt-2 text-2xl sm:text-3xl font-bold text-gray-900">{timeBasedCounts.total}</div>
                  ...
                  {tutors.map((tutor) => {
                    ...
                    return (
                      <tr key={tutor.user_id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{tutor.User?.email || "N/A"}</div>
                          <div className="text-sm text-gray-500">{tutor.User?.mobile_number || "N/A"}</div>
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900">
                            Classes: {tutor.classes?.slice(0, 2).join(", ") || "N/A"}
                            {tutor.classes?.length > 2 && "..."}
                          </div>
                          <div className="text-sm text-gray-500">
                            Subjects: {tutor.subjects?.slice(0, 2).join(", ") || "N/A"}
                            {tutor.subjects?.length > 2 && "..."}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-gray-900">{tutor.plan_name || "N/A"}</div>
                          <div className="text-xs text-gray-500">{tutor.days_remaining ?? "N/A"} days</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <select
                            value={tutor.profile_status}
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">{Math.min(page * ITEMS_PER_PAGE, timeBasedCounts.total)}</span> of{" "}
                    <span className="font-medium">{timeBasedCounts.total}</span> results
                    <span className="text-gray-500"> ({timeFilterOptions.find(opt => opt.value === timeFilter)?.label})</span>
                  </p>
                </div>
                <div className="flex gap-2">
                  <button
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Teaching Modes (comma separated)
                      </label>
                      <input
                        type="text"
                        value={newTutor.teaching_modes.join(', ')}
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">ID:</span> {selectedTutor.user_id}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Name:</span> {selectedTutor.name}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Email:</span> {selectedTutor.User?.email || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Phone:</span> {selectedTutor.User?.mobile_number || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Location:</span> {selectedTutor.Location?.city || "N/A"}, {selectedTutor.Location?.state || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Registration Date:</span> {formatDateForDisplay(selectedTutor.createdAt)}
                    </div>
                  </div>
                </div>
                ...
                {/* Professional Information */}
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-3 border-b pb-2">Professional Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Experience:</span> {selectedTutor.experience || "N/A"} years
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Pricing:</span> {selectedTutor.pricing_per_hour ? `₹${selectedTutor.pricing_per_hour}/hr` : "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Teaching Modes:</span> {selectedTutor.teaching_modes?.join(", ") || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Languages:</span> {formatLanguages(selectedTutor.languages)}
                    </div>
                  </div>
                </div>
                ...
                {/* Education & Subjects */}
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-3 border-b pb-2">Education & Subjects</h3>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Degrees:</span> {selectedTutor.degrees?.join(", ") || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Classes:</span> {selectedTutor.classes?.join(", ") || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Subjects:</span> {selectedTutor.subjects?.join(", ") || "N/A"}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-3 border-b pb-2">Subscription Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Plan:</span> {selectedTutor.plan_name || "N/A"}
                    </div>
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Days Remaining:</span> {selectedTutor.days_remaining ?? "N/A"}
                    </div>
                    <div className="text-sm">
                ...
                <div>
                  {selectedTutor?.documents && Object.keys(selectedTutor.documents).length > 0 ? (
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 mb-3 border-b pb-2">Uploaded Documents</h3>

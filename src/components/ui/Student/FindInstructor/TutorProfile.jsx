...
//       <div className="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8 pt-16">
//         <div className="max-w-5xl mx-auto">
//           {/* Header with back + share */}
//           <div className="flex justify-between items-center mb-6">
//             <button
//               onClick={() => navigate(-1)}
//               className="flex items-center text-gray-600 hover:text-teal-600 transition-colors bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200"
//             >
...
//                 }
//               }}
//               className="p-3 text-gray-500 hover:text-teal-600 rounded-full hover:bg-gray-100 transition-colors bg-white shadow-sm border border-gray-200"
//             >
//               <FiShare2 />
//             </button>
//           </div>
...
//                   alt={tutor.name}
//                   className="w-32 h-32 rounded-lg object-cover mx-auto md:mx-0 border-4 border-teal-100"
//                 />
//               </div>
...
//                   <button
//                     onClick={handleLoginRedirect}
//                     className="flex items-center justify-center gap-2 border border-teal-500 text-teal-500 px-6 py-3 rounded-lg hover:bg-teal-50 transition-colors flex-1 font-medium shadow-sm"
//                   >
...
//               <button
//                 className={`flex-1 md:flex-none px-6 py-4 text-center font-medium whitespace-nowrap transition-colors ${activeTab === "profile" ? "text-teal-600 border-b-2 border-teal-600 bg-white" : "text-gray-500 hover:text-gray-700 hover:bg-gray-100"}`}
//                 onClick={() => setActiveTab("profile")}
//               >
//                 Profile
//               </button>
//               <button
//                 className={`flex-1 md:flex-none px-6 py-4 text-center font-medium whitespace-nowrap transition-colors ${activeTab === "availability" ? "text-teal-600 border-b-2 border-teal-600 bg-white" : "text-gray-500 hover:text-gray-700 hover:bg-gray-100"}`}
//                 onClick={() => setActiveTab("availability")}
//               >
//                 Availability
//               </button>
//               <button
//                 className={`flex-1 md:flex-none px-6 py-4 text-center font-medium whitespace-nowrap transition-colors ${activeTab === "classes" ? "text-teal-600 border-b-2 border-teal-600 bg-white" : "text-gray-500 hover:text-gray-700 hover:bg-gray-100"}`}
//                 onClick={() => setActiveTab("classes")}
//               >
//                 Classes
//               </button>
//               <button
//                 className={`flex-1 md:flex-none px-6 py-4 text-center font-medium whitespace-nowrap transition-colors ${activeTab === "reviews" ? "text-teal-600 border-b-2 border-teal-600 bg-white" : "text-gray-500 hover:text-gray-700 hover:bg-gray-100"}`}
...
//                             <span
//                               key={idx}
//                               className="px-3 py-1 bg-teal-100 text-teal-800 rounded-lg font-medium text-sm border border-teal-200"
//                             >
//                               {subject}
//                             </span>
//                           ))}
...
//                           <div className="flex items-start gap-3 px-3 py-2 bg-gray-50 rounded-lg border border-gray-200">
...
//                             <div key={idx} className="flex items-start gap-3 px-3 py-2 bg-gray-50 rounded-lg border border-gray-200">
...
//                             <div className="bg-teal-100 p-2 rounded-full mr-3 border border-teal-200">
...
//                               className="text-sm bg-teal-500 text-white px-3 py-1 rounded hover:bg-teal-600 transition-colors font-medium"
//                             >
//                               Enroll
//                             </button>
//                           </div>
...
//                             <div className="bg-teal-100 text-teal-800 w-10 h-10 rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0 border border-teal-200">
...
export default function TutorProfilePage() {
  ...
  const handleViewContact = async () => {
    try {
      const response = await apiClient.get(`/contacts/view/${id}`);
  ...
  const handleRaiseEnquiry = () => {
    const subjects = tutor?.subjects || tutorProfile?.subjects || [];
    const classes = tutor?.classes || tutorProfile?.classes || [];
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 border border-gray-200">
          ...
          <div className="p-6 flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-grow">
              ...
              {/* Contact Buttons - View Contact & Raise Enquiry */}
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <button

...
//         );
//         toast.error("Location details incomplete. Please try again.");
//       } else {
//         setError(errMsg);
//         toast.error(errMsg);
//       }
...
//             setError("");
//             if (data) toast.success("Location selected successfully!");
//           }}
...
//           <p className="text-xs text-yellow-800 mb-2">
//             <strong>Note:</strong> If the auto-detected details above don't look
//             correct, please try searching for a more specific location (e.g.,
//             "Srinagar, Jammu and Kashmir" instead of just "Jammu and Kashmir").
//           </p>
//         </div> */}
...
//           <button
//             onClick={handleSubmit}
//             disabled={loading || !locationData?.place_id}
//             className="flex-1 bg-teal-500 hover:bg-teal-600 disabled:bg-teal-300 text-white py-2 rounded-md text-sm"
//           >
//             {loading ? "Saving..." : "Save & Continue"}
//           </button>

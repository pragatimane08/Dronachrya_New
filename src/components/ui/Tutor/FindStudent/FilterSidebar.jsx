...
// const FilterSidebar = ({ onApply, isOpen, onClose, isMobile, showHeading }) => {
...
//   const languageOptions = ["English", "Hindi", "Marathi", "Bengali", "Tamil", "Telugu", "Gujarati", "Kannada", "Malayalam", "Punjabi"];
...
//   return (
//     <>
//       {/* Mobile Overlay - Updated to start below top bar */}
//       {isMobile && isOpen && (
//         <div 
...
//       {/* Sidebar */}
//       <div className={`${sidebarClass} bg-white rounded-xl shadow border border-gray-200 flex flex-col`}>
...
//             Filter Students
//           </h2>
//           {/* Show close button on mobile and tablet devices */}
//           <button
//             onClick={onClose}
//             className="p-2 rounded-full hover:bg-gray-200 transition-colors flex-shrink-0 md:hidden"
...
//                 <label key={option} className="flex items-center space-x-3 text-sm cursor-pointer">
//                   <input
//                     type="checkbox"
...
//                   <label key={language} className="flex items-center space-x-3 text-sm cursor-pointer">
//                     <input
//                       type="checkbox"
...
//                 ))
//               ) : (
//                 <p className="text-xs text-gray-400 italic text-center py-2">No matches found</p>
//               )}
//             </div>

//             {/* Clear / Apply inside Languages */}
...
//               onChange={(e) =>
//                 setFilters({ ...filters, tutor_gender_preference: e.target.value })
//               }
//               className="w-full border border-gray-300 px-3 py-2.5 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
//             >
...
//                 <label key={mode} className="flex items-center space-x-3 text-sm cursor-pointer">
//                   <input
//                     type="checkbox"

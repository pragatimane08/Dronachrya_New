...
>>>>>>> 3bea3b4e806b9fecfcdd44d2621a910b6e8449ed
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white w-full max-w-2xl rounded-lg shadow-lg p-5 relative mx-4">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="mt-4 flex justify-between items-center">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 border border-teal-500 text-teal-500 rounded text-sm hover:bg-teal-50 transition-colors"
          >
            <BookmarkIcon className="w-4 h-4" />
            {student.isBookmarked ? "Remove Bookmark" : "Save to Bookmarks"}
          </button>
          <button
            onClick={onClose}

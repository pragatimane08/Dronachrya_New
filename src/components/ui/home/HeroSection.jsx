...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-20 max-w-4xl mx-auto min-h-screen">
        ...
        <div className="w-full max-w-2xl flex items-stretch justify-center gap-0 z-50">
          <Listbox value={selectedSubject} onChange={setSelectedSubject}>
            <div className="relative w-full">
              <Listbox.Button className="w-full p-3 text-left text-gray-700 text-sm md:text-base bg-white font-medium border-r-0 rounded-l-md shadow-none focus:outline-none relative h-[42px] md:h-[46px] flex items-center">
          ...
          <button
            className="bg-[#564FC6] text-white px-6 py-2 text-sm md:text-base font-semibold rounded-r-md hover:bg-[#453bb5] transition h-[42px] md:h-[46px] flex items-center justify-center"

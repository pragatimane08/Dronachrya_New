...
import bgVideo from "../../../assets/img/her_video.mp4"; // video background
    ...
    <section className="relative text-white min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white drop-shadow-lg"> Expert Tutoring, Tailored to Your Child&apos;s Success </h1> <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-gray-100 leading-relaxed drop-shadow-md"> One-on-one lessons with qualified tutors — at your home or online. Personalized support for all subjects, all grades. </p>

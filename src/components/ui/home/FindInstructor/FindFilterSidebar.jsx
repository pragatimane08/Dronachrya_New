...
function SidebarContent({
  ...
  return (
    <div>
      ...
      {/* Removed scrollable container - showing all fields directly */}
      <div className="space-y-4">
        ...
        {/* Budget - Updated to vertical layout with Min and Max labels */}
        <div>
          <label className="text-sm font-medium block mb-1 text-gray-700">Budget (₹/hr)</label>
          <div className="space-y-2">
            <div>
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-teal-500"
              />
              <div className="text-xs text-gray-500 mt-1 text-center">Min (≥100)</div>
            </div>
            <div>
              <input
                type="number"

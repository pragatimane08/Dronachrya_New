...
import Tutor from "../../../assets/img/teacher2.jpg"; // Adjust the path as necessary

const LookingToTeach = () => {
  return (
    <section className="bg-blue-100 rounded-xl py-10 px-4 sm:px-6 lg:px-8 mx-4 my-10 max-w-6xl mx-auto">

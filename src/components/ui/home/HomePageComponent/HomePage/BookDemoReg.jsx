...
//       if (otpSent || accountExistsNotVerified) {
...
//           setErrors({
//             submit: "Account already exists but not verified. New OTP sent."
//           });
//         } else {
//           setErrors({
//             submit: errorMessage
...
//           {errors.submit && (
//             <div className={`border px-4 py-3 rounded mb-4 text-sm ${errors.submit.includes('successfully') || errors.submit.includes('New OTP sent')
...
//           {step === 9 && (
//             <div className="space-y-6">
//               {!otpSent && !accountExistsNotVerified ? (
//                 <>
//                   <div>
//                     <label className="block text-sm font-medium mb-2 text-gray-700">
//                       Full Name *
...
export default function BookDemoReg() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      if (selectedModes.main === "online") classModes.push("Online");
      if (selectedModes.main === "offline") {
        if (selectedModes.offlineType === "home") {
          classModes.push("Offline-StudentHome");
        } else if (selectedModes.offlineType === "nearby") {
          classModes.push("Offline-TutorHome");
        }
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      // Fixed: Properly set teaching modes based on selection
      const teachingModes = [];
      if (selectedModes.main === "online") {
        teachingModes.push("Online");
      } else if (selectedModes.main === "offline") {
        if (selectedModes.offlineType === "home") {
          teachingModes.push("Offline-StudentHome");
        } else if (selectedModes.offlineType === "nearby") {
          teachingModes.push("Offline-TutorHome");

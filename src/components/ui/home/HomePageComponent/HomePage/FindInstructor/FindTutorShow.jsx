...
export default function FindTutorShow() {
  ...
  // Check if this is an initial load with no filters applied
  const isInitialState =
    !loading &&
    tutors.length === 0 &&
    !error &&
    !demoFilters &&
    JSON.stringify(filters) === JSON.stringify(initialFiltersFromYou);
        ...
        <div className="max-w-7xl mx-auto p-4 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="grid gap-4">
                {isInitialState ? (
                  // No recent enquiry state
                  <div className="bg-white rounded-2xl shadow-md p-8 text-center">
                    <svg className="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                        d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <h3 className="text-xl font-medium text-gray-700 mb-2">No Recent Enquiry</h3>
                    <p className="text-gray-500 mb-4">
                      It looks like you haven't made any enquiry yet. Please use the filters to find tutors that match your requirements.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      <button
                        ...
                        className="px-6 py-2 border border-teal-600 text-teal-600 rounded-lg hover:bg-teal-50 transition font-medium"
                      >

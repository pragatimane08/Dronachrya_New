...
const Tutor_Plan = ({ userType = "tutor" }) => {
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-[#0E2D63] text-xl sm:text-2xl font-semibold mb-2">
              {userType === "tutor"
                ...
                : "Upgrade Your Student Subscription"}
            </h2>
            <p className="text-gray-600 text-xs sm:text-sm px-2">
              {userType === "tutor"
                ? "Boost your teaching career with flexible tutor plans designed to fit your needs."
                : "Select the best plan to unlock premium features and learn from expert tutors."}
            </p>

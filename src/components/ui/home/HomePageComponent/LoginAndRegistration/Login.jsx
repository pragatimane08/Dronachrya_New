...
// import { X, Eye, EyeOff, AlertCircle, CheckCircle2 } from "lucide-react"; // Icons
...
//   const [inlineMessage, setInlineMessage] = useState(null); // 👈 custom inline messages
...
//     // Only students should be able to send OTP
//     if (role !== "student") {
//       setInlineMessage({
//         type: "error",
//         text: "Please select Student role to use OTP login",
//       });
//       return;
//     }

//     if (!/^[0-9]{10}$/.test(input.trim())) {
//       setInlineMessage({ type: "error", text: "Please enter a valid 10-digit mobile number." });
//       return;
//     }
...
//         setInlineMessage({
//           type: "error",
//           text: "This account is registered as a Tutor. Please use Tutor login with password.",
//         });
//         setLoading(false);
//         return;
//       }
...
//           {inlineMessage && (
//             <div
//               className={`flex items-center gap-2 px-3 py-2 rounded text-sm mb-3 ${inlineMessage.type === "error"
...
//                   className={`w-full border px-3 py-2 rounded outline-none focus:ring ${errors.otp ? "border-red-500" : "focus:ring-[#35BAA3]"
//                     }`}
//                   value={otp}
...
//     try {
//       setLoading(true);
//       const res = await authRepository.resendOtp({ emailOrMobile: input.trim() });
//       if (res.data?.success) {

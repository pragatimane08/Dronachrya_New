...
//             try {
//                 console.log("🔄 Topbar - Starting name extraction...");
...
//                         console.log("✅ Found name in userData.profile.name:", name);
//                     } else if (userData.name) {
//                         name = userData.name;
//                         console.log("✅ Found name in userData.name:", name);
//                     } else if (userData.firstName) {
//                         name = userData.firstName;
//                         console.log("✅ Found name in userData.firstName:", name);
//                     } else if (userData.first_name) {
//                         name = userData.first_name;
//                         console.log("✅ Found name in userData.first_name:", name);
//                     } else if (userData.profile?.first_name) {
//                         name = userData.profile.first_name;
//                         console.log("✅ Found name in userData.profile.first_name:", name);
//                     }
...
//                         console.log("🎉 Set name from userData:", firstName);
//                         return;
//                     }
//                 }
                
//                 // Priority 2: Fallback to localStorage/sessionStorage
//                 console.log("🔍 userData not available, checking storage...");
...
//                         console.log("✅ Found name in storage user.profile.name:", name);
//                     } else if (user.name) {
//                         name = user.name;
//                         console.log("✅ Found name in storage user.name:", name);
//                     } else if (user.firstName) {
//                         name = user.firstName;
//                         console.log("✅ Found name in storage user.firstName:", name);
//                     } else if (user.first_name) {
//                         name = user.first_name;
//                         console.log("✅ Found name in storage user.first_name:", name);
//                     }
...
//                         setUserName(firstName);
//                         setAvatarInitial(firstName.charAt(0).toUpperCase());
//                         console.log("🎉 Set name from storage:", firstName);
//                         return;
//                     }
//                 }
                
//                 // Final fallback
//                 console.log("⚠️ No name found, using role-based fallback");
...
//             console.log("🔄 Auth change detected, reloading user name...");
//             extractUserName();
//         };
